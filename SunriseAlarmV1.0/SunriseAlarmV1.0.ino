...
void Buz(int brightness)
{
  if(digitalRead(set)==0)
  off=0;
  if(off==1)
  {
   analogWrite(buz, brightness);
   delay(500);
  }
}
...
void TimeCheck()
{
  ...
  {
     add=11;
     int nowInMinutes=Min+60*Hor;
     int alarmTimeInMinutes=tem[12]+60*tem[11];
     int minSinceAlarmTime=nowInMinutes-alarmTimeInMinutes;
     if (minSinceAlarmTime<=alarmLength)
     {
       int brightness = pow (2, (minSinceAlarmTime / R)) - 1;
       Buz(brightness);
       //lcd.clear();
       //lcd.print("alarm...........");
       lcd.setCursor(0,1);
...
void setup()
{
 ...
 //exponential rate
  R = (alarmLength * log10(2))/(log10(255));
}
////////////////////////////////////////////////////////////loop/////////////////////////////////////
void loop()
{
